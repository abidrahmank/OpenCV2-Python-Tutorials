...
In this chapter, we will review the basics of ORB.


Theory
==========

As an OpenCV enthusiast, you will be excited to know that ORB is develped by OpenCV Labs. This algorithm was published by Ethan Rublee, Vincent Rabaud, Kurt Konolige and Gary R. Bradski in their paper **ORB: An efficient alternative to SIFT or SURF** in 2011. As the title says, it is a good alternative to SIFT and SURF in with comparable computation cost and performance - but not patented. Yes, SIFT and SURF are patented and you are supposed to pay them for its use. But ORB is not !!!
