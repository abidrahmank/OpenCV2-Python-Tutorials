...
2. `Basic Numpy Tutorials <https://numpy.org/devdocs/user/quickstart.html>`_
3. `OpenCV Documentation <http://docs.opencv.org/>`_
4. `OpenCV Forum <http://answers.opencv.org/questions/>`_
